...
const HilbertCurveStrategy = (unsorted) => {
    ...
    for (let x = 0; x < unsorted.length; x++) {
        ...
        for (let y = 0; y < unsorted[x].length; y++) {
            idx[y] = y;
            hilbertValues[y] = encode(parseInt(unsorted[x][y].latitude), parseInt(unsorted[x][y].longitude), 100);
        }
...
const ZOrderCurveStrategy = (unsorted) => {
    ...
    for (let x = 0; x < unsorted.length; x++) {
        ...
        for (let y = 0; y < unsorted[x].length; y++) {
            idx[y] = y;
            zValues[y] = encode(parseInt(unsorted[x][y].latitude), parseInt(unsorted[x][y].longitude));
        }
